...
pub type CallFuture = web3::helpers::CallFuture<
    Vec<Address>,
    Box<dyn Future<Item = rpc::Value, Error = web3::Error>>,
>;
...
impl BlockchainConnector {
    ...
    pub fn deploy(
        &self,
        bytes: &[u8],
    ) -> Result<web3::contract::deploy::Builder<web3_adapter::Transports>, ethabi::Error> {
